...
kable(allTracts.Summary) %>%
  ...
  footnote(general_title = "\n",
           general = "Table 1.2")
```
# plugged in a different variation (from lab rmd) of the table that unites year and TOD/Non as a column and variable from row and rounds 2 decimal places- JR
```{r}
allTracts.Summary %>%
...
ggplot() +
  geom_sf(data = tracts09, fill = "grey90") +
